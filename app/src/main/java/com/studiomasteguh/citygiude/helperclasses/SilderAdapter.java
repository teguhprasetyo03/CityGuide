package com.studiomasteguh.citygiude.helperclasses;
...
public class SilderAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        TextView heading = view.findViewById(R.id.tv_header_sleading);
        TextView desc = view.findViewById(R.id.tv_slider_desc);
